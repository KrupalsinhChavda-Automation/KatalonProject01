...
WebUI.waitForElementVisible(findTestObject('Object Repository/Home Page/Menu_TestCases'), 10)
WebUI.click(findTestObject('Object Repository/Home Page/Menu_TestCases'))
