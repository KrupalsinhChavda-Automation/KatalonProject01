...
'Click on Up button at buttom'
WebUI.click(findTestObject('Object Repository/Home Page/btn_Up'))

'Verify text'
WebUI.scrollToElement(findTestObject('Object Repository/Home Page/verify_HomePage'), 10)
WebUI.verifyElementText(findTestObject('Object Repository/Home Page/verify_HomePage'), 'Full-Fledged practice website for Automation Engineers')